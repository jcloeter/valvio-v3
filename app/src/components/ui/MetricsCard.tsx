        ...
        <LightGreyCard>
            <Container>
                <section>
                    <p>
                        {' '}
                        <b>Level {quizSlice.quizLevel}.</b> {quizSlice.quizName}
                    </p>
                    <p>
                        {' '}
                        {quizSlice.isTransposition ? (
                            <>
                                <b>Transposition: </b>
                                {quizSlice.transpositionDescription}
                            </>
                        ) : (
                            <>
                                <b>Mode:</b> Pitch Recognition
                            </>
                        )}
                    </p>
                </section>
                <MetricIcons>
                    <ul className={styles['metric-icons-ul']}>
                        ...
                        <li className={styles['metric-icons-li']}>
                            ...
                            <p className={styles['metric-icons-text']}>
                                {currentPitchIndex}/{quizSlice.quizLength}
                            </p>
                        </li>
                        <li className={styles['metric-icons-li']}>
